		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP UI5 Project",
									"targetURL": "#comxtendhrdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comxtendhrdemo-display": {
								"semanticObject": "comxtendhrdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.xtendhr.demo",
									"url": sap.ui.require.toUrl("com/xtendhr/demo")
								}
							}
						}
					}
